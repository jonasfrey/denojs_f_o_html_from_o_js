...
let f_o_js = function(
    ...
    let o = Object.assign(
        o_state, 
        {
            ...
            a_s_css_propval: (o_state?.a_s_css_propval) ? 
                o_state?.a_s_css_propval : 
                [
                    'border-radius: 3px'
                ]
        }
    ...
    let o_js__translatable_scalable_window = f_o_assigned(
        'o_js__translatable_scalable_window', 
        {
            f_o_jsh: async ()=>{
                console.log('asdf')
                return {
                    class: a_s_class.join(' '),
                    style: [
                        `position: absolute`, 
    ...
    return o_js__translatable_scalable_window;
