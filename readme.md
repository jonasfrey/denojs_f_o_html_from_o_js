<!-- {"s_msg":"this file was automatically generated","s_by":"f_generate_markdown.module.js","s_ts_created":"Tue May 09 2023 14:53:03 GMT+0200 (Central European Summer Time)","n_ts_created":1683636783420} -->
# usage
## import library
```javascript
import {
    ...
    return {
      a_o: [
        ...a_s_animal.map(function(
          ...
          return {
            s_tag: `animal number ${n_idx} is called: '${s}'`
          }
        })
      ]
    }
